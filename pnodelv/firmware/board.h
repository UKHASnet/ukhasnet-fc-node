 ...
 * Board identifier.
 */
#define BOARD_PNODELV
#define BOARD_NAME                  "pNodeLV"
...
#define GPIOA_RADIO_SHDN                  7U
#define GPIOA_PIN8                  8U
#define GPIOA_SCL                   9U
#define GPIOA_SDA                   10U
 ...
 */
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_CLAMP) |         \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_CLAMP) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_RADIO_SHDN) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN8) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SCL) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SDA) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN11) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN12) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SWDAT) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SWCLK) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN15))
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOA_CLAMP) |     \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_CLAMP) |     \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_CLAMP) |           \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_CLAMP, 0) |         \
